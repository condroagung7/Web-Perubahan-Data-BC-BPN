            ...
            <div key={nama} className="flex items-center justify-between gap-3 px-4 py-3">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium text-slate-700 dark:text-slate-300 truncate">{nama}</p>
                  {info && (
                    <p className="text-xs text-green-600 truncate">{info.nama_file}</p>
                  )}
                  {isError && (
                    <p className="text-xs text-red-600">Gagal unggah, coba lagi (maks 10MB)</p>
                  )}
                </div>
              </div>
              ...
              <label className="shrink-0 cursor-pointer">
                ...
                />
                <span
                  className={`inline-flex items-center gap-1.5 text-xs font-medium rounded-md px-3 py-1.5 transition ${
                    info
